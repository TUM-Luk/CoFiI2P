...
if __name__=='__main__':
    ...
    parser.add_argument("--eval_path", type=str, default = "eval_results_epoch7", help = "path for evaluation files")
    args = parser.parse_args()

    args.dataset = "kitti"
    args.ckpt = "checkpoints/kitti/20240904-144413/mode_epoch_7.t7"
    ...
    with torch.no_grad():
        ...
        np.save('%s_t_error_epoch7.npy'%args.dataset, t_diff_set)
        np.save('%s_r_error_epoch7.npy'%args.dataset, angles_diff_set)
